      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-3 sm:p-6">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-xl max-h-[92vh] overflow-y-auto bg-white/50 backdrop-blur-[40px] rounded-[40px] sm:rounded-[56px] shadow-[0_48px_96px_rgba(0,0,0,0.2),inset_0_1px_1px_rgba(255,255,255,0.5)] border border-white/60"
          >
            <div className="bg-[#1A1A1A]/90 p-6 sm:p-10 text-white relative overflow-hidden backdrop-blur-md">
              <div className="absolute top-0 right-0 p-8 opacity-10 pointer-events-none">
                <FileText size={120} />
              </div>
              <div className="relative z-10">
                <div className="flex justify-between items-center mb-4 sm:mb-6">
                  <h3 className="text-2xl sm:text-3xl font-bold tracking-tight">Financial Entry</h3>
                  <button 
                    onClick={onClose}
                ...
                <p className="text-gray-400 font-medium tracking-tight sm:max-w-[80%]">Audit and record new transactions seamlessly into your ledger.</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="p-5 sm:p-10 space-y-5 sm:space-y-8">
              ...
              <div className="flex p-1.5 bg-black/[0.03] backdrop-blur-xl rounded-[28px] border border-black/5 ring-1 ring-white/20">
                <button
                  ...
                  className={cn(
                    "flex-1 flex items-center justify-center gap-2 sm:gap-3 py-4 rounded-[18px] text-[10px] uppercase tracking-widest font-bold transition-all",
                    type === 'PAYMENT' ? "bg-white text-[#1A1A1A] shadow-[0_8px_16px_rgba(0,0,0,0.05)]" : "text-gray-400 hover:text-gray-600"
                  )}
                >
                ...
                <button
                  ...
                  className={cn(
                    "flex-1 flex items-center justify-center gap-2 sm:gap-3 py-4 rounded-[18px] text-[10px] uppercase tracking-widest font-bold transition-all",
                    type === 'DEBT' ? "bg-[#3D4E3D] text-[#EFE7D2] shadow-[0_8px_16px_rgba(61,78,61,0.2)]" : "text-gray-400 hover:text-gray-600"
                  )}
                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <label className="text-[9px] font-bold text-gray-400 uppercase tracking-[0.2em] ml-2">Debtor Identity</label>
                  <div className="relative group">
                    ...
                    <select 
                      ...
                      required
                      className="w-full pl-14 pr-10 py-5 bg-white/40 rounded-[28px] border border-white shadow-sm focus:ring-4 focus:ring-black/5 appearance-none font-bold text-sm tracking-tight outline-none transition-all hover:bg-white/60"
                    >
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      required
                      className="w-full pl-14 pr-6 py-5 bg-white/40 rounded-[28px] border border-white shadow-sm focus:ring-4 focus:ring-black/5 font-bold text-sm outline-none transition-all hover:bg-white/60" 
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:flex gap-3 sm:gap-4 pt-4">
                ...
                <button 
                  ...
                  disabled={!isValid}
                  className={cn(
                    "flex-[1.5] py-4 sm:py-5 rounded-[28px] text-[10px] font-bold uppercase tracking-[0.2em] shadow-xl transition-all active:scale-95",
                    type === 'PAYMENT' ? "bg-[#1A1A1A] text-white shadow-black/10 hover:bg-black" : "bg-[#3D4E3D] text-[#EFE7D2] shadow-[#3D4E3D]/20 hover:brightness-110",
